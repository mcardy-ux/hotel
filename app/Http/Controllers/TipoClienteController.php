...
class TipoClienteController extends Controller
{
    ...
    {
        return view("parameters.tipoCliente.index");
    }
    ...
    {
        return view("parameters.tipoCliente.create");
    }
    ...
    public function store(Request $request)
    {
        ...
        $validator = Validator::make($request->all(), [
            'codigo' => 'bail|required|unique:tipo_clientes|max:180',
     ...
     *
     * @param  \App\Models\parameters\tipoCliente  $tipoCliente
     * @return \Illuminate\Http\Response
     */
    public function edit($id)
    {
        $data=tipoCliente::where('id',\Hashids::decode($id)[0])->first();
        return view("parameters.tipoCliente.edit",['data'=>$data]);
    }
    ...
    { 
        $reg=tipoCliente::findOrFail(\Hashids::decode($id)[0]);
    ...
    {
        $reg = tipoCliente::find(\Hashids::decode($id)[0])->delete();
    ...
    public function ajaxRequestTipoCliente(){
        $query = tipoCliente::all();
        ...
        ->addColumn('actions', function ($query) {
            return '<div class="dropdown d-inline-block">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuButtonUser" x-placement="bottom-start" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(0px, 37px, 0px);">
                    <a class="dropdown-item" href="'. url('tipoCliente', [$query->encode_id,'edit']) .'">Editar</a>
