...
use App\Models\parameters\motivoViaje;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Validator;

class MotivoViajeController extends Controller
{
    /**
    ...
    */
    ...
    {
        return view("parameters.motivoViaje.index");
    }
    ...
    {
        return view("parameters.motivoViaje.create");
    }
    ...
    public function store(Request $request)
    {
        $validator = Validator::make($request->all(), [
            'codigo' => 'bail|required|unique:motivo_viajes|max:180',
     ...
     *
     * @param  \App\Models\parameters\motivoViaje  $motivoViaje
     * @return \Illuminate\Http\Response
     */
    public function edit($id)
    {
        $data=motivoViaje::where('id',\Hashids::decode($id)[0])->first();
        return view("parameters.motivoViaje.edit",['data'=>$data]);
    }
    ...
    {
        $reg=motivoViaje::findOrFail(\Hashids::decode($id)[0]);
    ...
    {
        $reg = motivoViaje::find(\Hashids::decode($id)[0])->delete();
    ...
    public function ajaxRequestmotivoViaje(){
        $query = motivoViaje::all();
        ...
        ->addColumn('actions', function ($query) {
            return '<div class="dropdown d-inline-block">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuButtonUser" x-placement="bottom-start" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(0px, 37px, 0px);">
                    <a class="dropdown-item" href="'. url('motivoViaje', [$query->encode_id,'edit']) .'">Editar</a>
