...
use App\Models\parameters\motivoCancelacion;
...
{ /**
   ...
   {
       return view("parameters.motivoCancel.index");
   }
   ...
   {
       return view("parameters.motivoCancel.create");
   }
   ...
   public function store(Request $request)
   {
       $validator = Validator::make($request->all(), [
           'codigo' => 'bail|required|unique:motivo_cancelacions|max:180',
       ...
       motivoCancelacion::create($validated);
    ...
    *
    * @param  \App\Models\parameters\motivoCancelacion  $motivoCancelacion
    * @return \Illuminate\Http\Response
    */
   public function edit($id)
   {
       $data=motivoCancelacion::where('id',\Hashids::decode($id)[0])->first();
       return view("parameters.motivoCancel.edit",['data'=>$data]);
   }
   ...
   {
       $reg=motivoCancelacion::findOrFail(\Hashids::decode($id)[0]);
   ...
   {
       $reg = motivoCancelacion::find(\Hashids::decode($id)[0])->delete();
   ...
   public function ajaxRequestmotivoCancel(){
       $query = motivoCancelacion::all();
       ...
       ->addColumn('actions', function ($query) {
           return '<div class="dropdown d-inline-block">
               ...
               <div class="dropdown-menu" aria-labelledby="dropdownMenuButtonUser" x-placement="bottom-start" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(0px, 37px, 0px);">
                   <a class="dropdown-item" href="'. url('motivoCancel', [$query->encode_id,'edit']) .'">Editar</a>
