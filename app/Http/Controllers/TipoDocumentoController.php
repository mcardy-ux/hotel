...
class TipoDocumentoController extends Controller
{
    ...
    {
        return view("parameters.tipoDocs.index");
    }
    ...
    {
        return view("parameters.tipoDocs.create");
    }
    ...
    public function store(Request $request)
    {
        $validator = Validator::make($request->all(), [
            'codigo' => 'bail|required|unique:tipo_documentos|max:180',
        ...
        tipo_documento::create($validated);
     ...
     *
     * @param  \App\Models\parameters\tipo_documento  $tipo_documento
     * @return \Illuminate\Http\Response
     */
    public function edit($id)
    {
        $data=tipo_documento::where('id',\Hashids::decode($id)[0])->first();
        return view("parameters.tipoDocs.edit",['data'=>$data]);
    }
    ...
    {
        $reg=tipo_documento::findOrFail(\Hashids::decode($id)[0]);
    ...
    {
        $reg = tipo_documento::find(\Hashids::decode($id)[0])->delete();
    ...
    public function ajaxRequestTipoDocs(){
        $query = tipo_documento::all();
        ...
        ->addColumn('actions', function ($query) {
            return '<div class="dropdown d-inline-block">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuButtonUser" x-placement="bottom-start" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(0px, 37px, 0px);">
                    <a class="dropdown-item" href="'. url('tipoDocs', [$query->encode_id,'edit']) .'">Editar</a>
