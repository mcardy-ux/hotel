...
$(document).ready(function(){
    ...
    $('#add_tipoCliente').submit(function(event){
        ...
        let confirmacion=confirm("¿Esta seguro de agregar esta información?");
          if(confirmacion){
            ...
            var data = $('#add_tipoCliente').serialize();
            $.ajax({
              url: $('#add_tipoCliente #_url').val(),
              headers: {'X-CSRF-TOKEN': $('#add_tipoCliente #_token').val()},
              type: 'POST',
              cache: false,
              data: data,
              success: function (response) {
                ...
                if(json.success){
                  alert('Tipo de Cliente creado exitosamente');
                  location.href=$('#add_tipoCliente #_url').val();
                }else{
                  alert(json.data);
                }
              }
