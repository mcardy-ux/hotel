...
$(document).ready(function(){
    ...
    $('#add_motivoCancel').submit(function(event){
        ...
        let confirmacion=confirm("¿Esta seguro de agregar esta información?");
          if(confirmacion){
            ...
            var data = $('#add_motivoCancel').serialize();
            $.ajax({
              url: $('#add_motivoCancel #_url').val(),
              headers: {'X-CSRF-TOKEN': $('#add_motivoCancel #_token').val()},
              type: 'POST',
              cache: false,
              data: data,
              success: function (response) {
                ...
                if(json.success){
                  ...
                  location.href=$('#add_motivoCancel #_url').val();
                }else{
                  alert(json.data);
                }
              }
