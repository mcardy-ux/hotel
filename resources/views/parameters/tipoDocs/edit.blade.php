...
<main>
                ...
                <div class="col-12">
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            <form role="form" id="edit_tipoDocs"  name="edit_tipoDocs" >
                                <input type="hidden" id="_url"  value="{{ url('tipoDocs', [$data->encode_id])}}">
    ...
    @endsection
    @push('scripts')
    <script src="{{ asset('js/parameters/tipoDocs/edit.js') }}"></script>
