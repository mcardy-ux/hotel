...
<main>
                ...
                <div class="col-12">
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            <form role="form" id="edit_eventos"  name="edit_eventos" >
                                <input type="hidden" id="_url"  value="{{ url('eventos', [$data->encode_id])}}">
    ...
    @endsection
    @push('scripts')
    <script src="{{ asset('js/parameters/eventos/edit.js') }}"></script>
