...
<main>
                ...
                <div class="col-12">
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            <form role="form" id="add_eventos" name="add_eventos" accept-charset="UTF-8" >
                            <input type="hidden" id="_url" value="{{ url('eventos') }}">
    ...
    @endsection
    @push('scripts')
    <script src="{{ asset('js/parameters/eventos/create.js') }}"></script>
