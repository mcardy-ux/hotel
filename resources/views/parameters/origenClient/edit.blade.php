...
<main>
                ...
                <div class="col-12">
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            <form role="form" id="edit_origens"  name="edit_origens" >
                                <input type="hidden" id="_url"  value="{{ url('origenCliente', [$data->encode_id])}}">
    ...
    @endsection
    @push('scripts')
    <script src="{{ asset('js/parameters/origenCliente/edit.js') }}"></script>
