...
<main>
                ...
                <div class="col-12">
                    ...
                    <nav class="breadcrumb-container d-none d-sm-block d-lg-inline-block" aria-label="breadcrumb">
                        <ol class="breadcrumb pt-0">
                            ...
                            <li class="breadcrumb-item">
                                <a href="{{route('origenCliente.index')}}">Listado</a>
                            </li>
                ...
                <div class="col-12">
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            <form role="form" id="add_origen_clients" name="add_origen_clients" accept-charset="UTF-8" enctype="multipart/form-data">
                            <input type="hidden" id="_url" value="{{ url('origenCliente') }}">
                                ...
                                <a href="{{ route('origenCliente.index') }}"> 
    ...
    @endsection
    @push('scripts')
    <script src="{{ asset('js/parameters/origenCliente/create.js') }}"></script>
