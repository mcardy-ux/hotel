...
<main>
                ...
                <div class="col-12">
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            <form role="form" id="add_motivoViaje" name="add_motivoViaje" accept-charset="UTF-8" >
                            <input type="hidden" id="_url" value="{{ url('motivoViaje') }}">
    ...
    @endsection
    @push('scripts')
    <script src="{{ asset('js/parameters/motivoViaje/create.js') }}"></script>
