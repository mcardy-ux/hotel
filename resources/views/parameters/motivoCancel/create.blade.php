...
<main>
                ...
                <div class="col-12">
                    ...
                    <nav class="breadcrumb-container d-none d-sm-block d-lg-inline-block" aria-label="breadcrumb">
                        <ol class="breadcrumb pt-0">
                            ...
                            <li class="breadcrumb-item">
                                <a href="{{route('motivoCancel.index')}}">Listado</a>
                            </li>
                ...
                <div class="col-12">
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            <form role="form" id="add_motivoCancel" name="add_motivoCancel" accept-charset="UTF-8" >
                            <input type="hidden" id="_url" value="{{ url('motivoCancel') }}">
                                ...
                                <a href="{{ route('motivoCancel.index') }}"> 
    ...
    @endsection
    @push('scripts')
    <script src="{{ asset('js/parameters/motivoCancel/create.js') }}"></script>
