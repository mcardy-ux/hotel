...
<main>
                ...
                <div class="col-12">
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            <form role="form" id="edit_motivoCancel"  name="edit_motivoCancel" >
                                <input type="hidden" id="_url"  value="{{ url('motivoCancel', [$data->encode_id])}}">
    ...
    @endsection
    @push('scripts')
    <script src="{{ asset('js/parameters/motivoCancel/edit.js') }}"></script>
