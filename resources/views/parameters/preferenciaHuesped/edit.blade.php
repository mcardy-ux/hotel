...
<main>
                ...
                <div class="col-12">
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            <form role="form" id="edit_prefHuesped"  name="edit_prefHuesped" >
                                <input type="hidden" id="_url"  value="{{ url('prefHuesped', [$data->encode_id])}}">
    ...
    @endsection
    @push('scripts')
    <script src="{{ asset('js/parameters/prefHuesped/edit.js') }}"></script>
