                ...
                <div class="col-12">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card mb-4">
                                <div class="card-body">
                                    <h5 class="mb-4">Puede actualizar la informacón requerida.</h5>
                                    <form role="form" id="edit_user" name="edit_user" >
                                        <input type="hidden" id="_url" value="{{ url('user', [$data->encode_id]) }}">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-10">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" name="acceso" id="RadioActivo" value="1" {{ $data->status == 1 ? 'checked' : '' }}>
                                                        <label class="form-check-label" for="RadioActivo">
                                                            Activo
                                                        </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" name="acceso" id="RadioInactivo" value="0" {{ $data->status == 0 ? 'checked' : '' }}>
