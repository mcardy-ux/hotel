            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="top-right-button-container">
                        <div class="btn-group">
                            <a href="{{url('sectoresHab/create')}}" >
                                    <button type="button" class="btn btn-primary mb-1">Agregar un nuevo Sector de Habitación</button>
                            </a>
                        </div>
                    </div>
                    <div class="separator mb-5"></div>
                    <form id="index_sectoresHab" name="index_sectoresHab">
