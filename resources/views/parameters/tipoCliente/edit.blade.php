...
<main>
                ...
                <div class="col-12">
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            <form role="form" id="edit_tipoCliente"  name="edit_tipoCliente" >
                                <input type="hidden" id="_url"  value="{{ url('tipoCliente', [$data->encode_id])}}">
    ...
    @endsection
    @push('scripts')
    <script src="{{ asset('js/parameters/tipoCliente/edit.js') }}"></script>
