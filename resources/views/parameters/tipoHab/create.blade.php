...
<main>
                ...
                <div class="col-12">
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            <form role="form" id="add_data_tiposHab" name="add_data_tiposHab" >
                            <input type="hidden" id="_url" value="{{ url('tiposHab') }}">
                                <input type="hidden" id="_token" value="{{ csrf_token() }}">
                                <div class="form-row">
                                
                                    
                                    <div class="form-group col-md-6">
                                        <label for="descripcion">Descripción del tipo de habitación:</label>
    ...
    @endsection
    @push('scripts')
    <script src="{{ asset('js/parameters/tiposHab/create.js') }}"></script>
    @endpush
