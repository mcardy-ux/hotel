                ...
                <div class="col-12">
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            <form role="form" id="add_data_habitacion" name="add_data_habitacion" accept-charset="UTF-8">
                            <input type="hidden" id="_url" value="{{ url('habitacions') }}">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="number" class="form-control" id="capacidad_huespedes" name="capacidad_huespedes"
